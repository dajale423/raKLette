...
# command='snakemake --cluster "sbatch -c {resources.cpus_per_task} -t {resources.runtime} -p {resources.partition} --mem={resources.mem_mb}" --rerun-incomplete --latency-wait 30 --keep-going'
